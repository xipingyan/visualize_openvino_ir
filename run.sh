...
python main.py -m $model -id $layer_id --top 10 --bottom 1 --ignore_const -highlight 'MatMul'
# python main.py -m $model -name $layer_name --top 10 --bottom 1 --ignore_const -highlight 'MatMul'
